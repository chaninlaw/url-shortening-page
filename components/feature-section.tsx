...
export function FeaturesSection() {
	return (
		<section className='relative after:w-[100vw] after:absolute after:-left-[0.5%] after:bg-accent-foreground  after:inset-0 after:-z-10 lg:py-10 lg:after:-left-[4.5%] xl:after:-left-[3%]'>
			<AdvancedStatistics />
